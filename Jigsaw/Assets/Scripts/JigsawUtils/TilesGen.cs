...
//    //IEnumerator Coroutine_FillPoly(Tile tile)
//    //{
//    //    while(tile.mStack.Count > 0)
//    //    {
//    //        tile.FloodFillStep();
//    //        tile.FinalCut.Apply();
//    //        yield return null;
...
//        Sprite sprite = SpriteUtils.CreateSpriteFromTexture2D(tile.FinalCut, 0, 0, 140, 140);
//        spriteRenderer.sprite = sprite;

//        //StartCoroutine(Coroutine_FillPoly(tile));
//    }
//}
